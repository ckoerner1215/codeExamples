...
c********************************************************
        ...
        program writeSEQBinaryFile4_different
     ...
     &      trim(adjustl(string2))//"_diff"//".bin4"
     ...
     &       action="write",form="unformatted")
           ...
           do i=1,nlines
              do j=1,nelementsPerRecord
                 block(j)=3.11111*float(i)
                 write(6,'(f12.9)'),block(j)
              end do
     ...
     &        filename_trim
        ...
        end program writeSEQBinaryFile4_different
