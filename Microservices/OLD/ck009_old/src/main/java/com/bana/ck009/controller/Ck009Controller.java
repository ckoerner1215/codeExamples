...
import com.bana.ck009.model.Module;
...
public class Ck009Controller {
        ...
        public Module help() {
                ...
                module.setName("ck009");
                module.setDescription("This is the description for ck009");
                module.setInfile1("/app/prod/ck009/input.dat");
                module.setOutputDirectory("/app/prod/ck009/OUTPUT");
                module.setScriptLocation("/app/prod/ck009");
                module.setExecutableLocation("/app/prod/ck009");
                return module;
        }
