...
! While this may not be desired behavior, it keeps this example simple.
     ...
     &       negative_average=0.
         ...
         print *,'Starting ck009 - program Average'

         open(unit=9, action="read", status="old")
         open (unit=10,file="ck009-out.txt",action="write")


         read(9,"(A)",iostat=ierr)header
	  read (9,*) number_of_points
...
! Print result to Unit 10
     ...
     &        negative_average
	  ...
	  print *,'Done with program Average - module ck009'
	  print *,'See ck009-out.txt for output'
